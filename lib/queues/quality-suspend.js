...
export const SUSPEND_CHECK_INTERVAL = getJobInterval('quality-suspend-check', 900000); // 15 min
export const SUSPEND_RECOVER_INTERVAL = getJobInterval('quality-suspend-recover', 300000); // 5 min
